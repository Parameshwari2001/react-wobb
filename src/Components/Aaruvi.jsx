    ...
    return (<>
        ...
        <div className={styles.container}>
            ...
            <div className={styles.head}>
                ...
                <p className={styles.head_brand}>Aaruvi</p>
            </div>
            ...
            <div className={styles.middle_parent}>
                <div className={styles.middle_part1}>
                    ...
                    <img className={styles.logo} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBWIf8w6Sdh3IBOQbrdswgeHK0Pq4CA8CGJA&s" alt="" />
                </div>

                <div className={styles.middle_part2}>
                    <div className={styles.info}>
                        <p style={{ marginLeft: '1rem', fontSize: '1.5rem', fontWeight: 'lighter' }}>Aaruvi</p>
                        <div >
