    ...
    return (<>
        ...
        <div className={styles.container}>
            ...
            <div className={styles.head}>
                ...
                <p className={styles.head_brand}>Trends</p>
            </div>

            <div className={styles.middle_parent}>
                <div className={styles.middle_part1}>
                    <img className={styles.images} src="https://static.wixstatic.com/media/3f3442_df728349d21e4ce0ba0343165c13bb5a~mv2.jpg/v1/fill/w_1920,h_1080,al_c/3f3442_df728349d21e4ce0ba0343165c13bb5a~mv2.jpg=" alt="" />
                ...
                <div className={styles.middle_part2}>
                    <div className={styles.info}>
                        <p style={{ marginLeft: '1rem', fontSize: '1.5rem', fontWeight: 'lighter' }}>Trends Global</p>
                        <div >
